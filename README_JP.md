...
### ハイライト :bulb:
> このプロジェクトでは、開発者がソースコードを公開する必要はありません。
> 最終的なバイナリファイルのみをアップロードすればよく、これは App Store にアップロードされる `.app` ファイルにやや似ています。
> 主な目的は、皆がクリエイティビティを共有できるようにしながら、コードのプライバシーを損なわないことです。
